...
Tf_x = 8;
[T_x, X_sub_x, U_sub_x] = rocket.simulate_f(sys_x, x0_x, Tf_x, @mpc_x.get_u, 0);
...
Tf_y = 8;
[T_y, X_sub_y, U_sub_y] = rocket.simulate_f(sys_y, x0_y, Tf_y, @mpc_y.get_u, 0);
...
% z closed loop controller
Tf_roll = 8;
[T_roll, X_sub_roll, U_sub_roll] = rocket.simulate_f(sys_roll, x0_roll, Tf_roll, @mpc_roll.get_u, 0);
